...
parser.add_argument('--min_time', type=int, nargs='?', default=5, help='min_time step')

parser.add_argument('--max_time', type=int, nargs='?', default=12, help='max_time step')

parser.add_argument('--experiment', type=int, nargs='?', default=1, help='experiment id')
...
parser.add_argument('--window', type=int, nargs='?', default=2,
