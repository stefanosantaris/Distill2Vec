...
print("Window "+ str(FLAGS.window) + " Num PARAMS " + str(num_params))
...
#
# final_results = {"n_params":num_params, 'MICRO' :{'VAL_AUC': val_results['HAD'][0], 'TEST_AUC': test_results['HAD'][0]}, 'MACRO': { 'VAL_AUC': val_results['HAD'][1], 'TEST_AUC':test_results['HAD'][1]}}
#
# if not path.exists('results'):
#     os.mkdir('results')
# f = open("results/" +
#          FLAGS.dataset +
#          '_emb_' + FLAGS.structural_layer_config +
#          '_heads_' + FLAGS.structural_head_config +
#          '_window_' + str(FLAGS.window) +
#          '_ts_' + str(FLAGS.time_steps) +
#          '_exp_' + str(FLAGS.experiment) +
#          '.pkl', "wb")
...
#                                                       test_edges, test_edges_false, epochs_embeds[-1],
#                                                       epochs_embeds[-1])
#
...
#
# final_results = {"n_params":num_params, 'VAL_AUC': val_results['HAD'][0], 'TEST_AUC':test_results['HAD'][0]}
#
# if not path.exists('results'):
#     os.mkdir('results')
# f = open("results/" +
